...
{
    public static void InitTestDb(this AuctionDbContext context)
    {
        context.Auctions.AddRange(GetTestAuctions());
        context.SaveChanges();
    }

    public static CreateAuctionDto GetCreateAuctionDto()
    {
    ...
    public static void ReInitTestDb(this AuctionDbContext context)
    {
